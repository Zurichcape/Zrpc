package com.zurich.utils.concurrent.threadpool;
...
public class ThreadPoolFactoryUtil {
     ...
     *
     * @param threadNamePrefix 线程池名前缀
     * @param customThreadPoolConfig 自定义线程池配置类
     * @return ExecutorService
     */
    ...
    public static ExecutorService createCustomThreadPoolIfAbsent(CustomThreadPoolConfig customThreadPoolConfig,String threadNamePrefix,Boolean daemon){
        ...
        //如果threadPool被shutdown或者terminate则重新创建一个
    ...
    /**
     * 创建 ThreadFactory。如果threadNamePrefix不为空则新建ThreadFactory，
    ...
    public static void printThreadPoolStatus(ThreadPoolExecutor threadPool){
        ScheduledExecutorService scheduledExecutorService = new ScheduledThreadPoolExecutor(1,createThreadFactory("print-pool-thread-pool-status",false));
